...
const mockNotifications: Notification[] = [
  {
    ...
    message:
      "You have received a deposit of $1,250.00 to your Main Checking account.",
    type: "transaction",
    isRead: false,
  ...
  },
  {
    ...
    message:
      "Your Savings Account balance is below $500. Consider adding funds to avoid fees.",
    type: "alert",
    isRead: true,
  ...
  },
  {
    ...
    message:
      "We've added a new currency converter tool to help you manage international transactions.",
    type: "info",
    isRead: true,
  ...
  },
  {
    ...
    message:
      "We noticed a login attempt from an unrecognized device. Please verify this was you.",
    type: "security",
    isRead: false,
  ...
  },
  {
    ...
    message:
      "Your recent transaction of $350.00 at Electronics Store was declined due to insufficient funds.",
    type: "transaction",
    isRead: false,
  ...
  },
  {
    ...
    message:
      "Your monthly account statement for March 2025 is now available for download.",
    type: "info",
    isRead: true,
            ...
            filteredNotifications.map((notification) => (
              ...
              >
                <div className="flex items-start space-x-4">
                  <div
                    className={`shrink-0 h-10 w-10 rounded-full ${getNotificationColor(notification.type)} flex items-center justify-center`}
                  >
                  ...
                  >
                    ...
                    <p
                      className={`text-sm ${expandedNotification === notification.id ? "" : "line-clamp-2"} ${!notification.isRead ? "text-blue-700" : "text-gray-500"}`}
                    >
          ...
          <div className="bg-gray-50 px-4 py-3 border-t border-gray-200 sm:px-6">
            <div className="flex justify-between items-center">
              <div className="text-sm text-gray-700">
                ...
                of <span className="font-medium">{notifications.length}</span>{" "}
                notifications
              </div>
              <div className="flex space-x-2">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    ...
                    <p className="text-gray-500">
                      Receive emails for significant account transactions.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
              ...
              <div className="mt-4 space-y-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    ...
                    <p className="text-gray-500">
                      Receive push notifications for account transactions.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    ...
                    <p className="text-gray-500">
                      Receive push notifications about security-related events.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    <label
                      htmlFor="push-balance"
                      className="font-medium text-gray-700"
                    >
                      Balance alerts
                    </label>
                    <p className="text-gray-500">
                      Receive push notifications when your balance is low.
                    </p>
                  </div>
                </div>
              </div>
